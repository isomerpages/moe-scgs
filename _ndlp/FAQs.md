...
### Device Usage and Learning Materials
...
**Q3. Will my child/ward need to purchase software for their devices? If so, can these be paid for with Edusave?**
...
**Q4. Can my child/ward share one device with her sibling/s who is/are also from SCGS?** 
...
### Internet Safety and Content Filtering

**Q1. How often does Jamf update its blocked content, including videos?**

Jamf updates its blocked sites database continuously, utilising a combination of automated machine learning and a dedicated team of data scientists and analysts to vet domain classifications. However, if you think that a site should be blocked but has not been, please write to us.

**Q2. Do the devices come with antivirus software preinstalled?**
...
**Q1. Which DMA Option should I choose for my child/ward?**

The PLD is intended for teaching and learning. The DMA restrictions are to help create a safe and conducive digital environment to manage distractions such as social media and games. While making a selection for the DMA Option, the school recommends that parents/guardians have conversations with their daughter/ward to understand their current device usage habits, and assess if she is able to regulate her device usage on her own. It may be prudent to start with the default setting first, which could be reviewed subsequently.

**Q2. What do we do if we want to change the Device Management Account (DMA)? How do we ensure that the change is not initiated by students?**

For a change in DMA, you may write to the school at scgss@moe.edu.sg. We will verify the email address that you have used against the official record. If the email address is not recognised, we may write to you to verify your request.

**Q3. How do teachers monitor the use of the PLDs during lessons?**

PLDs are only allowed during lessons with the permission of the teachers. When PLDs are used, teachers use Apple Classroom, a Classroom Management System, where they can monitor students' activities on the iPad and consult with the students if necessary.

**Q4. Will the devices be programmed to disallow students from downloading games?**
...
**Q5.  What happens to the device after my child/ward graduates?**
...
**Q1. What are the guidelines in place for communication between teachers and students, and student leaders and teachers?**

CCA teachers are to communicate with their students during CCA sessions or through CCA Google Classrooms (which has, among other functions, a bulletin board). CCA seniors are told to role model good communication habits and refrain from communicating after 8pm.

### Privacy and Monitoring

**Q1. Am I allowed to check my child's browsing history?**

Due to Apple's Privacy Policy, parents/guardians will not be able to track their child's browser history.

### Technical Support

**Q1. What is the insurance coverage for the iPad?**
...
**Q2. What do I do if my device is lost? Does the insurance cover it?**
...
**Q3. How do I replace a missing accessory?**
...
**Q4. Can students still send their devices to the contractor’s service centres for repairs after the end of the warranty period and how will the charges be imposed?**
...
**Q5. How long do I need to keep the device’s original packaging box before discarding it?**

Please keep the device original packaging box for at least 7 days in case of any 1-to-1 exchange.

**Q6. If my child use her existing Apple iPad, is she able to send her devices to the school service desk for repair?**
